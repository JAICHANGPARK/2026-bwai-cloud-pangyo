...
GDG Cloud Korea와 GDG Pangyo가 함께 준비한 **Build with AI Cloud x Pangyo 2026** 행사의 **Gemma 4 핸즈온 세션** 공식 리포지토리입니다.

## 참가자 사전 준비 가이드
핸즈온 세션에 원활하게 참여하기 위해, **행사 시작 전(5월 31일 일요일 오후 2시 이전)에** 아래 순서에 따라 실습 리포지토리를 복제하고 실습 도구 설치 및 Gemma 4 모델 다운로드를 완료해 주시기 바랍니다. 세션 진행 중 실시간으로 다운로드하면 대기 시간이 길어질 수 있으므로 사전 다운로드가 꼭 필요합니다.

### 0. 실습 리포지토리 복제 (Git Clone)
가장 먼저 터미널을 열고 본 실습 리포지토리를 복제(Clone)합니다:
```bash
...
*   **장소:** 온라인 행사 (상세 접속 정보는 신청 페이지 및 이메일 참고)
...
*   **신청 및 상세 링크:**
    ...
    *   [Luma 등록 페이지](https://luma.com/65d0o32r)
