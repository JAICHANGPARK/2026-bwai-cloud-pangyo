...
## 참가자 사전 준비 가이드
핸즈온 세션에 원활하게 참여하기 위해, **행사 시작 전(5월 31일 일요일 오후 2시 이전)에** 개인 노트북에 실습 도구 설치 및 Gemma 4 모델 다운로드를 완료해 주시기 바랍니다. 세션 진행 중 실시간으로 다운로드하면 대기 시간이 길어질 수 있으므로 사전 다운로드가 꼭 필요합니다.
